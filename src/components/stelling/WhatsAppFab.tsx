    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          style={{ position: "fixed", zIndex: 190, right: 20, bottom: 88 }}
        ...
        >
          ...
          <motion.a
            ...
            style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 52, height: 52, borderRadius: "50%", background: "#25D366", boxShadow: "0 6px 24px rgba(37,211,102,0.35)" }}
          >
