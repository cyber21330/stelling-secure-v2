  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (ringRef.current) {
        ...
        ringRef.current.style.borderColor = hovering ? "var(--text-primary)" : "var(--shield)";
        ringRef.current.style.background = hovering ? "var(--shield-dim)" : "transparent";
      }
    ...
    <>
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 8px rgba(155,168,181,0.8)",
        }}
      />
      <div
        ref={ringRef}
